...
install -d \
	...
	$RPM_BUILD_ROOT%{_iconsdir}/oxygen/{8x8,16x16,22x22,32x32,48x48,64x64,128x128}/{actions,animations,apps,categories,devices,emblems,emotes,mimetypes,places,special,status} \
	$RPM_BUILD_ROOT%{_iconsdir}/crystalsvg/{8x8,16x16,22x22,32x32,48x48,64x64,128x128}/{actions,animations,apps,categories,devices,emblems,emotes,mimetypes,places,special,status} \
